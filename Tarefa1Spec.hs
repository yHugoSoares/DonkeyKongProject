...
p1 = Personagem 3 Jogador (5,4) Leste (1,1) False False 10 0 (False, 0.0)
p2 = Personagem 3 Fantasma (4,4) Oeste (1,1) True False 2 0 (False, 0.0)

teste1 = "T1: Personagens colidem " ~: True ~=? colisoesPersonagens p1 p2

p3 = Personagem 3 Jogador (2,7) Leste (1,1) False False 10 0 (False, 0.0)
p4 = Personagem 3 Fantasma (4,4) Oeste (1,1) True False 2 0 (False, 0.0)

teste2 = "T2: Personagens nao colidem " ~: False ~=? colisoesPersonagens p3 p4

p5 = Personagem 3 Jogador (3,2) Leste (1,1) False False 10 0 (False, 0.0)
p6 = Personagem 3 Fantasma (3,3) Oeste (1,1) True False 2 0 (False, 0.0)
...
pl1 = Personagem 3 Jogador (8.5,6.5) Leste (0.6,0.6) False False 10 0 (False, 0.0)

teste4 = "T4: Jogador nao colide com nenhuma parede " ~: False ~=? colisoesParede mapaGrande pl1 Norte

pl2 = Personagem 3 Jogador (0.2,6.5) Leste (1,1) False False 10 0 (False, 0.0)

teste5 = "T5: Jogador colide com limite lateral " ~: True ~=? colisoesParede gameMap1 pl2

pl3 = Personagem 3 Jogador (8.5,0.2) Leste (1,1) False False 10 0 (False, 0.0)

teste6 = "T6: Jogador colide com limite superior " ~: True ~=? colisoesParede gameMap1 pl3

pl4 = Personagem 3 Jogador (7.5,2.5) Leste (2,2) False False 10 0 (False, 0.0)
