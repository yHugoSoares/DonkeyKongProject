...
desenhoJogador i j d (_,[marioO,marioL])
  | d == Oeste = Translate i j marioO
...
mario :: Personagem
mario = Personagem mov Jogador (40, -180) Oeste (16, 16) False False 1 0 (False, 0)

-- | Lista de inimigos no jogo.
malvados :: [Personagem]
malvados =
  [ Personagem 1 MacacoMalvado (100, 26) Oeste (39, 32) False True 1 0 (False, 0),
    Personagem 1 Fantasma (100, -204) Oeste (16, 16) False True 1 0 (False, 0),
    Personagem 1 Fantasma (160, -204) Oeste (16, 16) False True 1 0 (False, 0)
  ]