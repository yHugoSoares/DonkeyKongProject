...
alteraColisao k (Personagem velo a (x,y) dire c f g h i j) parede chao |(parede == True) && (chao == True) && (dire == Leste || dire == Sul) = (Personagem velo a (x-velo,y+velo) dire c f g h i j)
...
alteraJogada (Personagem velo a (x,y) dire c f g h i j) d e |d == Norte = (Personagem velo a (x,y+jump) Norte c f g h i j)
